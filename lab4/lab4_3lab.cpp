...
__m256d calc_ITERS(int j, __m256d P_upper_vector_pointer_in_row, __m256d P_lower_vector_pointer_in_row, std::size_t Nx, 
	__m256d P_upper_prev_vector, __m256d P_lower_prev_vector, __m256d U_prev_vector_value, __m256d U_curr_vector_value, 
	__m256d U_next_vector_value, __m256d U_upper, __m256d U_lower, __m256d* calculated_vector_pointer_in_row) {
	...
	return SUB(ADD(MUL(InputData.v_2cnst, U_curr_vector_value), s3), *calculated_vector_pointer_in_row);
...
#pragma omp single
		for (int k = 0; k < ITERS; k++) {
			*calculated_vector_pointer_in_row = calc_ITERS(j, *P_upper_vector_pointer_in_row, *P_lower_vector_pointer_in_row, Nx, 
				P_upper_prev_vector, P_lower_prev_vector, U_prev_vector_value, U_curr_vector_value, U_next_vector_value, *U_upper, 
				*U_lower, calculated_vector_pointer_in_row);
